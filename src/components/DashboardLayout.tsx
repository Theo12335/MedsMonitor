...
export default function DashboardLayout({
  ...
  const navItems = userRole === "caregiver" ? caregiverNav : patientNav;
    ...
    <div className="min-h-screen bg-[#030712] flex">
      ...
      >
          ...
          <Link href="/" className="flex items-center gap-3">
            ...
            {isSidebarOpen && (
              <div className="flex flex-col">
                <span className="font-bold text-white text-sm">Smart Care</span>
        ...
        <button
          ...
          className="p-4 border-t border-[#1e293b] text-slate-400 hover:text-white transition-colors"
        >
          <svg
      ...
      <div className="flex-1 flex flex-col">
        {/* Top Header */}
        <header className="h-16 bg-[#0f172a] border-b border-[#1e293b] px-6 flex items-center justify-between">
